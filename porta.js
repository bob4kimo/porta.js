...
function useFuncInputOrDefault(input,inputChildName,def) {
    ...
    // var isInputChildExist = jsonStr.indexOf(inputChildName+'":')>-1;
    // var inputChildValue = (new Function('return' + jsonStr+'.'+inputChildName))();
    // return isInputValid(input)&&isInputChildExist?inputChildValue:def;
...
function TipBox(v) {
    ...
    // var xx = isInputValid(v)&&isInputValid(v.x)?v.x:100;
    var yy = isInputValid(v)&&isInputValid(v.y)?v.y:100;
    var ww = isInputValid(v)&&isInputValid(v.w)?v.w:200;
    var hh = isInputValid(v)&&isInputValid(v.h)?v.h:50;
    //----- triangle's direction:north,east,south,west / 0,1,2,3 -----//
    var triDirection = isInputValid(v)&&isInputValid(v.triDirection)?v.triDirection:0;
    //----- shape triangle -----//
    var triangleW = isInputValid(v)&&isInputValid(v.triangleW)?v.triangleW:20;
    var triangleH = isInputValid(v)&&isInputValid(v.triangleH)?v.triangleH:10;
    var bgColor = isInputValid(v)&&isInputValid(v.bgColor)?v.bgColor:'4e886f';
    var cornerR = isInputValid(v)&&isInputValid(v.cornerR)?v.cornerR:'7';
